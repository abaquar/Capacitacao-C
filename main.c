...
typedef struct{         //Estrutura dos tiles do mapa
    ...
    short passavel;     //passavel   -> Determina se entidades podem andar por cima do tile
}TILE_STRUCT;
...
short MAPA_ATUAL[LARGURA_TELA*ALTURA_TELA]; //Matriz com ids dos tiles do mapa atual. Por convenção o mapa sempre é do tamanho da tela
